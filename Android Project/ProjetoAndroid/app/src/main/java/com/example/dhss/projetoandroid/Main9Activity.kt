...
class Main9Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var buttonNext = findViewById<Button>(R.id.button9)

        val barcelona:Double = intent.getDoubleExtra("temperatura" , 0.0)

        textViewCidade = findViewById<TextView>(R.id.textViewCidade)
        textViewTemperatura = findViewById<TextView>(R.id.textViewTemp)

        Thread{
            var cidade = CidadeClimaServiceBarcelona.getClimaCidade()
            runOnUiThread {
        ...
        buttonNext.setOnClickListener {
            ...
            intent.putExtra("temperatura", ottawa)
